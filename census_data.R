...
write.csv(pop_2015_zips, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\population_zip_2015.csv', row.names = F)
...
write.csv(zips, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\population_zip_2018.csv', row.names = F)

#Combined populations tables
population_zip_2015 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\population_zip_2015.csv', stringsAsFactors = F)
population_zip_2018 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\population_zip_2018.csv', stringsAsFactors = F)
...
write.csv(population_data_zip, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\population_data_zip.csv', row.names = F)
...
write.csv(income_data_city, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_data_city.csv')


#income_data_county
#Downloaded directly from data.census.gov, using topic = 'Population' and geographies = 'county' + 'Texas'.
#Cleaned up the files from the Census zip file download using Excel. Renamed file name and column names. Removed all cols except for geography and income estimate. 
income_county_2015 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_county_2015.csv', stringsAsFactors = F)
income_county_2018 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_county_2018.csv', stringsAsFactors = F)
...
write.csv(income_data_county, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_data_county.csv', row.names = F)
...
write.csv(income_zip_2015, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_zip_2015.csv', row.names = F)
...
write.csv(income_zip_2018, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_zip_2018.csv', row.names = F)

#combined file
income_zip_2015 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_zip_2015.csv', stringsAsFactors = F)
income_zip_2018 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_zip_2018.csv', stringsAsFactors = F)

income_data_zip <- full_join(income_zip_2015, income_zip_2018, by = 'zip') %>%
  select(zip, income_zip_2015, income_zip_2018)

write.csv(income_data_zip, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_data_zip.csv', row.names = F)


#income_data_city
#Downloaded directly from data.census.gov, using topic = 'Income and Earnings' and geographies = 'place' + 'Texas'.
#Cleaned up the files from the Census zip file download using Excel. Renamed file name and column names. Removed all cols except for geography and income estimate.
income_city_2015 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_city_2015.csv', stringsAsFactors = F)
income_city_2018 <- read.csv('C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_city_2018.csv', stringsAsFactors = F)
...
write.csv(income_data_city, 'C:\\Users\\nicho\\OneDrive\\Nick\\Data & Math\\Useful Files\\income_data_city.csv', row.names = F)
